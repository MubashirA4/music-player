...
const Cards = ({image, title, text}) => {
  return (
    <>
      ...
      <div class="shadow-md rounded-xl bg-neutral-400/5 p-3">
        <div class="group relative">
          <img class="w-auto md:w-72 block rounded" src={image} alt="" />
          <div class="absolute bg-black rounded-2xl bg-opacity-0 group-hover:bg-opacity-60 w-60 h-full top-0 flex items-center group-hover:opacity-100 transition justify-evenly">
