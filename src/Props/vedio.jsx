...
const MusicVedio = ({ image, title, text, count }) => {
  return (
    <div class="shadow-md rounded-xl bg-neutral-400/5 w-full p-3">
      <div class="group relative">
        <img class="w-auto md:w-full block rounded" src={image} alt="" />
        <div class="absolute bg-black rounded-1xl bg-opacity-0 group-hover:bg-opacity-60 w-full h-full top-0 flex items-center group-hover:opacity-100 transition justify-evenly">
