...
const Songs = () => {
  ...
  return (
    <>
      {/* Weekly Top */}
      <div className=''>
        <h4 className='text-4xl font-bold pb-6 mt-14'>Weekly Top <span className='text-pink-700'>Songs</span></h4>
      ...
      {/* Trending */}
      <div>
        <h4 className='text-4xl w-full font-bold pt-16 pb-6'>Trending <span className='text-pink-700'>Songs</span></h4>
